...
export default function Initial({activeCNPJ}) {
  const { tenantName } = useContext(AuthContext);
    ...
    const message = `Olá, nós do ${tenantName} ficamos felizes em ter você com a gente! Queremos saber como foi sua experiência. Por gentileza, responda nossa pesquisa. É simples e rápido.  Vamos lá? Clique no link abaixo para começar.`
    const objReserva = {}
